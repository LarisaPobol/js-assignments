...
## Javascript Assignments  [![Build Status](https://travis-ci.org/LarisaPobol/js-assignments.svg?branch=master)](https://travis-ci.org/LarisaPobol/js-assignments)
...
```
* Open https://github.com/LarisaPobol/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
